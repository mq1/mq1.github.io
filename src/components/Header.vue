...
const emit = defineEmit(['showProjects', 'showAboutMe'])
</script>

<template>
  <header class="p-10 sm:shadow-xl sm:rounded-2xl sm:border-2">
    ...
    <div class="flex justify-around gap-2 pt-8">
      ...
      <button class="whitespace-nowrap text-base font-medium text-gray-500 hover:text-gray-900 dark:hover:text-gray-400" @click="emit('showAboutMe')">
        About me
      </button>
    </div>
  </header>
